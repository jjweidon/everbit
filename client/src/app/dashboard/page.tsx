...
export default function Dashboard() {
  ...
  const renderContent = () => {
    switch (selectedTab) {
      case 'overview':
        return <Overview overviewData={MOCK_DATA.overview} botStatus={botStatus} setBotStatus={setBotStatus} />;
      case 'portfolio':
        return <Portfolio portfolioData={MOCK_DATA.portfolio} />;
      case 'history':
        return <History tradeHistoryData={MOCK_DATA.tradeHistory} />;
      case 'settings':
        return <Settings botSettingsData={MOCK_DATA.botSettings} backtestData={MOCK_DATA.backtest} />;
      default:
        return null;
    }
  };
