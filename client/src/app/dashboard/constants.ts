...
export const MOCK_DATA = {
  ...
  tradeHistory: {
    trades: [
      { time: '2024-03-15 14:30', symbol: 'BTC', type: 'entry' as const, amount: 0.1, profit: null },
      { time: '2024-03-15 12:15', symbol: 'ETH', type: 'exit' as const, amount: 0.5, profit: 150000 }
    ]
  },
  botSettings: {
    algorithms: [
