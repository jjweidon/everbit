...
public class TradeService {
    ...
    @Transactional
    public Trade saveTrade(User user, String market, OrderResponse orderResponse, BigDecimal price, Strategy strategy) {
        Trade trade = Trade.of(user, market, orderResponse, price, strategy);
